...
class Path:
    ...
    def movie_uploads(self):
        """
        動画の置き場
        """
        return os.path.join(self.archive(), "movie_uploads")

    def movie_thumbnails_uploads(self):
        """
        動画のサムネイルの置き場
        """
        return os.path.join(self.archive(), "movie_thumbnails")
